...
function FormInput({children, name, type, placeholder, onChange, error} : {children: React.ReactNode, name: string, type: string, placeholder: string, onChange: (e: React.ChangeEvent<HTMLInputElement>) => any, error?: string}) {
